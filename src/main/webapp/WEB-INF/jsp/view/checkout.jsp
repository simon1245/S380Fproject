                ...
                <c:choose>
                    <c:when test="${pageContext.request.userPrincipal.name != null}"> 
                        ...
                        <security:authorize access="hasRole('USER') or hasRole('ADMIN')">
                            <a href="<c:url value="/user/edit/${pageContext.request.userPrincipal.name}" />"class="w3-bar-item w3-button w3-right w3-medium"><u>${pageContext.request.userPrincipal.name}</u
                            </a>
                        </security:authorize>
