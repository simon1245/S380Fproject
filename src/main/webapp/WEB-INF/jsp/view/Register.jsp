            ...
            <div class="w3-bar w3-xlarge w3-dark-grey w3-opacity w3-hover-opacity-off" id="myNavbar">
                ...
                <c:choose>
                    ...
                    <c:when test = "${language == 'en_US'}">  
                        <a href="<c:url value="/Register/zh-HK" />" class="w3-right w3-button w3-medium">中文</a>
                    </c:when>
            ...
            <div class="w3-content">
                ...
                <div class="w3-row  w3-border w3-border-brown w3-container w3-padding-32">
                    <form:form method="POST" enctype="multipart/form-data"
                        ...
                        <form:label path="username"  class="w3-large"><fmt:message key='register.username'/>: </form:label><br/>
                        <form:input type="text" path="username" class="w3-input" style="width:70%"  /><br/><br/>
                        <form:label path="password"  class="w3-large"><fmt:message key='register.password'/>:</form:label><br/>
